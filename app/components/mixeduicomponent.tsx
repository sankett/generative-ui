      ...
      <div>
        <div className="w-full max-w-xs  my-2 ">
          ...
          >
            ...
            <option value="List out products for men's clothing">List out products for men's clothing</option>
            <option value="For women's clothing list all products">For women's clothing list all products</option>
