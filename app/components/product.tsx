            ...
            <th className="text-left p-1 pl-4 "></th>
                ...
                {productlist.map((product, index) => (
                    <tr key={index} className="text-left p-1">
                        ...
                        <td className="text-left p-1 pl-4"><button type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-1 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Remove</button></td>
                    </tr>
                ))}
            </table>
        </div>
